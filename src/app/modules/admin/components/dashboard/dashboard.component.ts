...
export class DashboardComponent implements OnInit {
  ...
  startDateValue = formatDate(this.subtractdays(31), 'yyyy-MM-dd', 'en-US');
  styling = {
  ...
  ngOnInit() {
    ...
    this.jobsStatusCount({ Status: "Halted", StartDate: this.startDateValue, EndDate: this.endDateValue });
